...
impl<B: Backend> Batcher<B, QueueMetrics, QueueMetricsBatch<B>> for QueueMetricsBatcher<B> {
    fn batch(&self, items: Vec<QueueMetrics>, device: &B::Device) -> QueueMetricsBatch<B> {
